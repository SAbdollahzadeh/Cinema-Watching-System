...
<nav class="navbar navbar-dark navbar-custom py-2">
	<div class="container-fluid d-flex justify-content-between align-items-center">
		...
		<!-- Logo -->
		<span class="navbar-brand h5 m-0">🎬 Watchlist </span>
		...
		<div class="d-flex align-items-center gap-2">
			...
			<a href="${pageContext.request.contextPath}/app/user/index" class="btn btn-success btn-sm">
				🎛️ Dashboard
			</a>
			...
			<div class="col-lg-3 col-md-6 col-sm-12">
				<div class="card movie-card shadow-sm border-0 h-100 d-flex flex-column">
					...
					<div class="card-body d-flex flex-column">
						...
						<a class="btn btn-outline-danger btn-sm w-100 mt-auto"
						   href="${pageContext.request.contextPath}/app/user/remove-watchlist-movie?id=${movie.id}">
